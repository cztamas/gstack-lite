...
Shared reference for fetching, filtering, and classifying Greptile review comments on GitHub PRs. Both `/gl-review` (Step 2.5) and `/ship` (full gstack only, Step 3.75) reference this document.
