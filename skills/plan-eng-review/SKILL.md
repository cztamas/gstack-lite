...
Before finishing the review, add an ordered `## Semantic Commit Map` to the active plan file and the final implementation handoff. If no active plan file exists, include it in the final handoff only.
