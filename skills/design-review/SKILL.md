...
Goodwill: 70 ####################..........
  ...
  FINAL: 35/100 WARNING CRITICAL UX DEBT
```
...
1. **New deferred design findings** -> after the workflow's approval gate, create tracker items with impact level, category, and description
2. **Fixed tracked findings** -> update, close, move, or annotate them as the repository guidelines require; when no specific lifecycle is defined, annotate with "Fixed by /gl-design-review on {branch}, {date}"
