...
description: |
  ...
  site", "take a screenshot", or "dogfood this". (gstack-lite)
---
## Lite Preamble
...
# 2. Tell the user what happened (by asking the user)
...
`$B` is the browse binary (resolved from `$_ROOT/.gstack-lite/browse/dist/browse` or `$HOME/.gstack-lite/browse/dist/browse`).
