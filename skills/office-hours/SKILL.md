...
Ask these questions **ONE AT A TIME** with Blocking User Questions. Push on each one until the answer is specific, evidence-based, and uncomfortable. Comfort means the founder hasn't gone deep enough.
...
Ask these **ONE AT A TIME** with Blocking User Questions. The goal is to brainstorm and sharpen the idea, not interrogate.
...
Present as a Blocking User Question. Do NOT proceed without user approval of the approach.
