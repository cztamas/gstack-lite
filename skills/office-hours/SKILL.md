...
Ask these questions **ONE AT A TIME** by asking the user. Push on each one until the answer is specific, evidence-based, and uncomfortable. Comfort means the founder hasn't gone deep enough.
...
Ask these **ONE AT A TIME** by asking the user. The goal is to brainstorm and sharpen the idea, not interrogate.
...
- If the second opinion (Codex or host subagent) proposed a prototype in Phase 3.5, consider using it as a starting point for the creative/lateral approach.

**RECOMMENDATION:** Choose [X] because [one-line reason].

Present by asking the user. Do NOT proceed without user approval of the approach.
...
If `$D serve` is not available or fails, fall back to Ask the user:
...
{If second opinion ran in Phase 3.5 (Codex or host subagent): independent cold read - steelman, key insight, challenged premise, prototype suggestion. Verbatim or close paraphrase. If second opinion did NOT run (skipped or unavailable): omit this section entirely - do not include it.}
...
## Cross-Model Perspective
{If second opinion ran in Phase 3.5 (Codex or host subagent): independent cold read - coolest version, key insight, existing tools, prototype suggestion. Verbatim or close paraphrase. If second opinion did NOT run (skipped or unavailable): omit this section entirely - do not include it.}
...
Present the reviewed design doc to the user by asking the user:
...
Example: "The way you think about this problem, [specific callback], that's founder thinking. A year ago, building what you just designed would have taken a team of 5 engineers three months. Today you can build it this weekend with AI coding agents. The engineering barrier is gone. What remains is taste, and you just demonstrated that."
...
Then ask the user: "Would you consider applying to Y Combinator?"
...
22. "How To Talk To Users" (20 min, Gustaf Alstromer) - You don't need sales skills. You need genuine conversations about problems. The most approachable tactical talk for someone who's never done it. https://www.youtube.com/watch?v=z1iF1c8w5Lg
...
- **Questions ONE AT A TIME.** Never batch multiple questions into one user question.
